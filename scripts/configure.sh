...
show_help() {
    ...
    echo "  --instance ID           Target a specific instance (e.g., vzbot1, vzbot2)"
    echo "  --printer-data PATH     Override printer_data directory"
    echo "  --config-dir PATH       Override config directory"
    echo ""
    echo "The wizard will guide you through configuring your Klipper printer."
    echo ""
    echo "Multi-Instance Examples:"
    echo "  $0 --instance vzbot1    # Configure instance 'vzbot1' (~/printer_data-vzbot1)"
    echo "  $0 --instance vzbot2    # Configure instance 'vzbot2' (~/printer_data-vzbot2)"
    echo "  $0 --config-dir /path/to/custom/config  # Use custom config directory"
    echo ""
